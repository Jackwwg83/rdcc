 ...
 * Initialized during rdcc startup.
 */
 ...
 * asynchronously during rdcc startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during rdcc startup. It synchronously creates
 ...
 *
 * This should be called during rdcc shutdown. Stops all running LSP servers

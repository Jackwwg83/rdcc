      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Ruidong Code&apos;s functionality (eg. to reduce the risk of bugs

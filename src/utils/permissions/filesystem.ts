...
// Always ask when rdcc tries to edit its own config files
 ...
 * This is a per-user temporary directory used by rdcc for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by rdcc)

...
// Always ask when Ruidong Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Ruidong Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Ruidong Code)

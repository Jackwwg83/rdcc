...
/**
 * Resolve rdcc-specific path patterns for sandbox-runtime.
 *
 * rdcc uses special path prefixes in permission rules:
...
/**
 * Convert rdcc settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where rdcc started)

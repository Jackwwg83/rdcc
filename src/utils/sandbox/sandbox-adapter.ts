...
/**
 * Resolve Ruidong Code-specific path patterns for sandbox-runtime.
 *
 * Ruidong Code uses special path prefixes in permission rules:
...
/**
 * Convert Ruidong Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Ruidong Code started)

...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when rdcc was first started on this machine
  ...
  // rdcc usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first rdcc OAuth token
  ...
  // rdcc hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).

...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Ruidong Code was first started on this machine
  ...
  // Ruidong Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Ruidong Code OAuth token
  ...
  // Ruidong Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
